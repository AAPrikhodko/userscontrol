...
import "./ModalWindowAddUser.css"
import {addUser} from "../../contexts/reduxStore/usersReducer";

const ModalWindowAddUser = ({show, handleClose, addUser, handleAnyUserDidAdd}) => {
    ...
    >
        <div className="container bg-primary">
            <div className="h4 text-center my-4 text-white">Checkout form</div>
        </div>
                    ...
                    <div className="container mt-5">
                        ...
                        <div className="row mt-5">
                            <div className="col-sm-6 my-2">
                                ...
                                <input id="name" type="text" className="form-control" placeholder="Clint"
                            ...
                            <div className="col-sm-6 my-2">
                                ...
                                <input id="lastname" type="text" className="form-control" placeholder="Eastwood"
                    ...
                    <div className="container g-5">
                        <div className="row m-5">
                            <div className="col-sm-6 my-1">
                                <button className="btn btn-secondary btn-block badge-pill" onClick={handleClose}>
                                    <i className="bi bi-arrow-left"></i>  BACK </button>
                            </div>
                            <div className="col-sm-6 my-1">
                                <button className="btn btn-success btn-block badge-pill" type="submit" onClick={handleSubmit}>
                                    SUBMIT <i className="bi bi-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>)}
...
export default connect(null,{addUser})(ModalWindowAddUser)